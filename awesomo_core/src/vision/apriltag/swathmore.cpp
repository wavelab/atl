...
int SwathmoreDetector::illuminationInvariantTransform(cv::Mat &image) {
...
int SwathmoreDetector::changeMode(cv::Mat &image) {
  int image_width;
  int image_height;
  bool widths_equal;
  bool heights_equal;
...
int SwathmoreDetector::maskImage(TagPose tag_pose, cv::Mat &image, double padding) {
