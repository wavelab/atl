#ifndef WAVESIM_GAZEBO_GIMBAL_PLUGIN_HPP
#define WAVESIM_GAZEBO_GIMBAL_PLUGIN_HPP
...
void gazQuat2EigenQuat(gazebo::math::Quaternion gaz_q, Quaternion &eig_q) {
  eig_q.w() = gaz_q.w;
  eig_q.x() = gaz_q.x;
  eig_q.y() = gaz_q.y;
  eig_q.z() = gaz_q.z;
