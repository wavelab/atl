#ifndef WAVESIM_GAZEBO_QUADROTOR_PLUGIN_HPP
#define WAVESIM_GAZEBO_QUADROTOR_PLUGIN_HPP
...
#define POSE_MSG wavesim_msgs::msgs::RPYPose
#define VELOCITY_MSG gazebo::msgs::Vector3d
#define ATT_SETPOINT_MSG wavesim_msgs::msgs::AttitudeSetpoint
#define POS_SETPOINT_MSG wavesim_msgs::msgs::PositionSetpoint
#define VEL_SETPOINT_MSG wavesim_msgs::msgs::VelocitySetpoint
...
public:
  ...
  wave::quadrotor::QuadrotorModel quadrotor;
