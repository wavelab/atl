...
class VelocitySetpoint : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:atl_msgs.msgs.VelocitySetpoint)
 private:
...
inline double VelocitySetpoint::vx() const {
  // @@protoc_insertion_point(field_get:atl_msgs.msgs.VelocitySetpoint.vx)
  return vx_;
}
inline void VelocitySetpoint::set_vx(double value) {
  set_has_vx();
  vx_ = value;
  // @@protoc_insertion_point(field_set:atl_msgs.msgs.VelocitySetpoint.vx)
}
...
inline double VelocitySetpoint::vy() const {
  // @@protoc_insertion_point(field_get:atl_msgs.msgs.VelocitySetpoint.vy)
  return vy_;
}
inline void VelocitySetpoint::set_vy(double value) {
  set_has_vy();
  vy_ = value;
  // @@protoc_insertion_point(field_set:atl_msgs.msgs.VelocitySetpoint.vy)
}
...
inline double VelocitySetpoint::vz() const {
  // @@protoc_insertion_point(field_get:atl_msgs.msgs.VelocitySetpoint.vz)
  return vz_;
}
inline void VelocitySetpoint::set_vz(double value) {
  set_has_vz();
  vz_ = value;
  // @@protoc_insertion_point(field_set:atl_msgs.msgs.VelocitySetpoint.vz)
}
