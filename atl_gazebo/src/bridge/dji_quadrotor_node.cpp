...
int DJIQuadrotorNode::configure(const std::string &node_name, int hz) {
  ...
  ROSNode::registerPublisher<dji_sdk::LocalPosition>(DJI_GPS_POSITION_RTOPIC);
  ...
  // ROSNode::registerSubscriber(DJI_ATTITUDE_SETPOINT_RTOPIC, &DJIQuadrotorNode::attitudeControlCallback, this);
  // clang-format on
