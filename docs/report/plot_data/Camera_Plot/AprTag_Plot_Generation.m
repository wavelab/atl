...
plot(dist, (dist-measured_dist+0.03), 'b.', 'Markersize', 30);
...
ylabel('Error in Measured Distance [meters]',...
               'Fontsize', 30, ...
               'FontWeight', 'normal');
axis([0 3.5 -0.2 0.2]);
...
figure(3)
plot(FPS_Plotting_x, FrameRate(7:26), '-b.', 'Markersize', 30, 'linewidth', 2)
set(gca, 'XMinorTick', 'on', ...
          'YMinorTick', 'on', ...
          'FontWeight', 'bold', ...
          'Fontsize', 20);
